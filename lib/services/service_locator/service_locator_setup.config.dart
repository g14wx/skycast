...
import '../../data/search_directions/implementations/search_directions_requests.dart'
    as _i22;
import '../../data/search_directions/implementations/search_directions_service.dart'
    as _i24;
import '../../data/search_directions/protocols/i_search_directions_requests.dart'
    as _i21;
import '../../data/search_directions/protocols/i_search_directions_service.dart'
    as _i23;
import '../../data/weather_api/implementations/weather_api_requests.dart'
    as _i30;
import '../../data/weather_api/implementations/weather_api_service.dart'
    as _i32;
...
import '../../features/root/root/BloCs/weather_setup_bloc/weather_setup_bloc.dart'
    as _i40;
import '../../features/root/root_home/sub_modules/home_front/BloCs/get_weather_bloc/get_weather_bloc.dart'
    as _i41;
import '../../features/root/root_login/sub_modules/login/BloCs/login_bloc/login_bloc.dart'
    as _i52;
import '../../features/root/root_login/sub_modules/login/BloCs/login_state_bloc/login_state_bloc.dart'
    as _i38;
import '../../networking/implementations/api_paths.dart' as _i6;
import '../../networking/protocols/i_api_paths.dart' as _i5;
import '../../providers/app_settings_provider/app_settings_provider.dart'
    as _i49;
...
import '../../providers/auth_provider/auth_provider_store_manager/implementations/auth_provider_store_manager.dart'
    as _i45;
import '../../providers/auth_provider/auth_provider_store_manager/protocols/i_auth_provider_store_manager.dart'
    as _i44;
...
import '../../providers/weather_provider/weather_storage_manager/implementations/weather_store_manager.dart'
    as _i37;
import '../../providers/weather_provider/weather_storage_manager/protocols/i_weather_provider.dart'
    as _i34;
import '../../providers/weather_provider/weather_storage_manager/protocols/i_weather_store_manager.dart'
    as _i36;
...
import '../data_storage/protocols/i_initialization_of_data_storage_service.dart'
    as _i17;
import '../env_variables_service/implementations/env_variables_service.dart'
    as _i16;
...
import '../mock_services/mock_weather_api_service/mock_weather_api_service.dart'
    as _i33;
import '../mock_services/mock_weather_provider/mock_weather_provider.dart'
    as _i35;
import '../networking_service/DataService/implementations/data_service_http.dart'
    as _i12;
import '../networking_service/DataService/protocols/i_data_service.dart'
    as _i11;
import '../serverless_data_manager_service/implementations/serverless_data_manager_service.dart'
    as _i26;
import '../serverless_data_manager_service/protocols/i_serverless_data_manager_service.dart'
    as _i25;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i17.IInitializationOfDataStorageService<dynamic>>(
      () => _i18.InitializationOfDataStorageService());
  ...
  gh.singleton<_i23.ISearchDirectionsService>(
      _i24.SearchDirectionService(gh<_i21.ISearchDirectionsRequests>()));
  gh.factory<_i25.IServerlessDataManagerService>(
      () => _i26.ServerlessDataManagerService());
  ...
  gh.factory<_i36.IWeatherStoreManager>(
      () => _i37.WeatherStoreManager(gh<_i13.IDataStorage>()));
  gh.lazySingleton<_i38.LoginStateBloc>(
      () => _i38.LoginStateBloc(gh<_i19.ILoginService>()));
  ...
  gh.factory<_i41.GetWeatherBloc>(
      () => _i41.GetWeatherBloc(gh<_i31.IWeatherApiService>()));
  gh.factory<_i42.IAppSettingsStorageManager>(() =>
      _i43.AppSettingsStorageManager(dataStorage: gh<_i13.IDataStorage>()));
  gh.factory<_i44.IAuthProviderStoreManager>(
      () => _i45.AuthProviderStoreManager(gh<_i13.IDataStorage>()));
  gh.factory<_i46.IMapService>(
      () => _i47.MapService(gh<_i23.ISearchDirectionsService>()));
  ...
  gh.factory<_i49.AppSettingsProvider>(() => _i49.AppSettingsProvider(
      appSettingsManager: gh<_i42.IAppSettingsStorageManager>()));
  gh.factory<_i50.AuthProvider>(
      () => _i50.AuthProvider(gh<_i44.IAuthProviderStoreManager>()));
  gh.factory<_i19.ILoginService>(
