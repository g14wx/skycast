...
mixin _$ConditionTranslation {
  ...
  List<ConditionTranslationLanguages> get languages => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ConditionTranslationCopyWith<ConditionTranslation> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ConditionTranslationCopyWith<$Res> {
  factory $ConditionTranslationCopyWith(ConditionTranslation value, $Res Function(ConditionTranslation) then) =
      _$ConditionTranslationCopyWithImpl<$Res, ConditionTranslation>;
  @useResult
  $Res call({int code, String day, String night, int icon, List<ConditionTranslationLanguages> languages});
}

/// @nodoc
class _$ConditionTranslationCopyWithImpl<$Res, $Val extends ConditionTranslation>
...
/// @nodoc
abstract class _$$ConditionTranslationImplCopyWith<$Res> implements $ConditionTranslationCopyWith<$Res> {
  factory _$$ConditionTranslationImplCopyWith(
          _$ConditionTranslationImpl value, $Res Function(_$ConditionTranslationImpl) then) =
...
class __$$ConditionTranslationImplCopyWithImpl<$Res>
  ...
  __$$ConditionTranslationImplCopyWithImpl(
      _$ConditionTranslationImpl _value, $Res Function(_$ConditionTranslationImpl) _then)
      : super(_value, _then);
...
class _$ConditionTranslationImpl implements _ConditionTranslation {
  ...
  factory _$ConditionTranslationImpl.fromJson(Map<String, dynamic> json) => _$$ConditionTranslationImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._languages, _languages));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, code, day, night, icon, const DeepCollectionEquality().hash(_languages));

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$ConditionTranslationImplCopyWith<_$ConditionTranslationImpl> get copyWith =>
      __$$ConditionTranslationImplCopyWithImpl<_$ConditionTranslationImpl>(this, _$identity);
...
abstract class _ConditionTranslation implements ConditionTranslation {
  const factory _ConditionTranslation(
      ...
      required final List<ConditionTranslationLanguages> languages}) = _$ConditionTranslationImpl;

  factory _ConditionTranslation.fromJson(Map<String, dynamic> json) = _$ConditionTranslationImpl.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$$ConditionTranslationImplCopyWith<_$ConditionTranslationImpl> get copyWith => throw _privateConstructorUsedError;
}

ConditionTranslationLanguages _$ConditionTranslationLanguagesFromJson(Map<String, dynamic> json) {
...
mixin _$ConditionTranslationLanguages {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ConditionTranslationLanguagesCopyWith<ConditionTranslationLanguages> get copyWith =>
...
abstract class $ConditionTranslationLanguagesCopyWith<$Res> {
  factory $ConditionTranslationLanguagesCopyWith(
          ConditionTranslationLanguages value, $Res Function(ConditionTranslationLanguages) then) =
      _$ConditionTranslationLanguagesCopyWithImpl<$Res, ConditionTranslationLanguages>;
  @useResult
  $Res call({String lang_name, String lang_iso, String day_text, String night_text});
}

/// @nodoc
class _$ConditionTranslationLanguagesCopyWithImpl<$Res, $Val extends ConditionTranslationLanguages>
...
abstract class _$$ConditionTranslationLanguagesImplCopyWith<$Res>
  ...
  factory _$$ConditionTranslationLanguagesImplCopyWith(
          _$ConditionTranslationLanguagesImpl value, $Res Function(_$ConditionTranslationLanguagesImpl) then) =
...
class __$$ConditionTranslationLanguagesImplCopyWithImpl<$Res>
    extends _$ConditionTranslationLanguagesCopyWithImpl<$Res, _$ConditionTranslationLanguagesImpl>
    implements _$$ConditionTranslationLanguagesImplCopyWith<$Res> {
  __$$ConditionTranslationLanguagesImplCopyWithImpl(
      _$ConditionTranslationLanguagesImpl _value, $Res Function(_$ConditionTranslationLanguagesImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$ConditionTranslationLanguagesImpl implements _ConditionTranslationLanguages {
  const _$ConditionTranslationLanguagesImpl(
      {required this.lang_name, required this.lang_iso, required this.day_text, required this.night_text});

  factory _$ConditionTranslationLanguagesImpl.fromJson(Map<String, dynamic> json) =>
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.lang_name, lang_name) || other.lang_name == lang_name) &&
            (identical(other.lang_iso, lang_iso) || other.lang_iso == lang_iso) &&
            (identical(other.day_text, day_text) || other.day_text == day_text) &&
            (identical(other.night_text, night_text) || other.night_text == night_text));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, lang_name, lang_iso, day_text, night_text);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$ConditionTranslationLanguagesImplCopyWith<_$ConditionTranslationLanguagesImpl> get copyWith =>
      __$$ConditionTranslationLanguagesImplCopyWithImpl<_$ConditionTranslationLanguagesImpl>(this, _$identity);
...
abstract class _ConditionTranslationLanguages implements ConditionTranslationLanguages {
